...
go_repository(
    ...
    sum = "h1:KCMNsK1h5NfQ0p2f88gMt22ou2g3KV3q7TFNa+IntYA=",
    version = "v0.0.0-20211102064603-0df034cc7ff3",
)
...
go_repository(
    ...
    sum = "h1:IluYziDRy6ujwtDuCaIqOshD3Mg8Vo/EiE2DNYSHXKY=",
    version = "v0.0.0-20211102064458-c88795988f56",
)
